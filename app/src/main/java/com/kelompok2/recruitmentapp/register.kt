...
import com.kelompok2.recruitmentapp.databinding.ActivityRegisterBinding
import com.kelompok2.recruitmentapp.util.NODE_USER
...
class register : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.Login.setOnClickListener{
            val intent = Intent(this@register, com.kelompok2.recruitmentapp.Login::class.java)
